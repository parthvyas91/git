...
$controllers_available= array('main','addEntry','viewEntry','updateEntry','gameDescription');
...
function addEntry()
{
    ...
    if(isset($_POST['addGame']) && $_POST['addGame'] == "game")
    {
        ...
        $checkerror=$entryControl->addIntoEntry($_POST['title'],$_POST['gSerial'],$_POST['Price'],$_POST['Date'],$_POST['Stock'],$_POST['Sold']);
        if($checkerror == 'true')
        {
        require_once("./controllers/addEntry.php");
            $entryControl = new addEntry();
            $entryControl->displayEntry('mainView');
        }
        else
        {
        require_once("./controllers/addEntry.php");
            $entryControl = new addEntry();
            $entryControl->displayEntry($view,true);
        }
    }
