...
/* Get rid of results of query */
while (mysqli_more_results($con) && mysqli_next_result($con));
$multi_query = "DECLARE _now DATETIME;
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Grand Theft Auto V','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Assasin's Creed IV Black Flag','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Call of Duty Ghosts','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Battlefield 4','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Starcraft II','39.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Diablo III','39.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Warcraft III : BattleChest','19.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('The Settlers VII','9.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Total War Rome 2','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Xcomm enemy unknown','19.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Mario Party: Island Tour','39.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Guild Wars 2','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Pokemon White','29.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Pokemon Black','29.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Crysis 3','29.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Company of Heroes 2','59.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Prince of Persia : The forgotten Sand','49.50',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Lego Batman 2','19.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Lego Lord of the Ring','29.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Lego Pirates of the Carribean','19.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Lego Marvel Super heroes','29.99',`_now`);
...
SET _now := NOW();
Insert into Games(Title, Price, updatedAt) Values('Lego StarWars III','19.99',`_now`);
